...
class ChunkModel(BaseDataModel):
    ...
    async def get_projects_chunks(self, project_id: ObjectId, page_no: int=1, page_size:int=50):
    ...
    async def get_total_count_of_chunks(self, project_id: ObjectId):
        total_count = 0
        async with self.db_client() as session:
